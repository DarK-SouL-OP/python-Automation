...
#        web_browser search
            ...
            if 'on youtube' in query:
                ...
                pyautogui.click()
                pyautogui.moveTo(428, 29, duration=0.2)#(x=428, y=29) values search bar in 1080pscreen
                pyautogui.click()
                pyautogui.typewrite(search_string)
                time.sleep(1.75)
                pyautogui.moveTo(399, 263, duration=0.2)#(x=399, y=263) values search bar in 1080pscreen
                pyautogui.click()
...
#       opening applications
        ...
        # chatbot
            ...
            print('Hey there my friend, i am DarK SouL/Atif😈')
            speak('i am created by darksoul')
